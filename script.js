...
function showInfoAboutProduct(product){
    ...
    let ratingPop = document.querySelector('.rating-pop-txt');
    let brandPop = document.querySelector('.brand-pop');
    ...
    ratingPop.textContent = product.rating;
    brandPop.textContent = product.brand;
}