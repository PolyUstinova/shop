...
function showProduct(data){
    ...
    for (const product of allProducts) {
        ...
        <div class="product-card" id="${product.id}">
            ...
            <input type="button" value="Купить" class="buy-btn buy-card-btn"></input>
        </div>`;
    }
        ...
        <div class="main-info">
            ...
            <div class="main-txt">
                ...
                <div class="rating-pop">
                    ...
                    <p class="rating-pop-txt">${product.price}</p>
                </div>
                <p class="price">$<span class="price-pop">${product.price}</span></p>
                <input type="button" value="Купить" class="buy-btn pop-btn"></input>
            </div>
        </div>
